...
stringVarToConstant(String input) {
  ...
  String _processed = input;
  // String _matchGroup0;
  String _matchGroup1;
  // set the input if any
  if (input.isEmpty) return {'error': 'no input'};
...
Color getColorConst(String color) {
  ...
  if (color.isNotEmpty && color.startsWith('Colors')) {
...
class DataItem {
  ...
  //
  Map<String, String> get json => jsonDecode(data.toString());
  //
  @override
  String toString() {

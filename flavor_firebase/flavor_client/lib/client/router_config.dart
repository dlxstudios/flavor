...
typedef FlavorPageBuilder = Page Function(Uri uri, dynamic params);

class FlavorRouterConfig extends ChangeNotifier {
  FlavorRouterConfig({required this.routes, this.pageNotFound});

  // static FlavorRouterConfig of(BuildContext context) {
  //   return (Router.of(context).routerDelegate as FlavorRouterConfig);
  // }

  final Map<String, FlavorPageBuilder> routes;
  final FlavorPageBuilder? pageNotFound;

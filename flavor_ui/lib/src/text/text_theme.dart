...
class FlavorTextTheme with Diagnosticable {
  ...
  static FlavorTextTheme? of(BuildContext context) {
    final ThemeController? inheritedTheme =
        context.dependOnInheritedWidgetOfExactType<ThemeController>();
    return inheritedTheme!.theme.textTheme;
  }
}
...
class FlavorTextStyle {
  TextStyle get textStyle => TextStyle(
        ...
        color: FlavorColor(colorValue: color).value,
        fontSize: fontSize,

...
/// Creates a [FlavorColor] object that can convert strings, has values, and int into a [Color]
class FlavorColor {
  ...
  /// Default ( from string )
  FlavorColor({this.colorValue, Color? color}) {
    if (color != null) {
      _value = color;
      return;
    }
